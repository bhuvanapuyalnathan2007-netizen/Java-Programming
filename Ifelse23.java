...
public class Ifelse23 {
       public static void main(String[] args) {
        ...
        if (alignmentStatus.equals("Well Aligned")) {
            ...
            if (riskTolerance.equalsIgnoreCase("Aggressive") && riskCategory.equals("Very High")) {
                ...
                recommendation = "Portfolio is within acceptable range but could be optimized";
                rebalancing = "Minor adjustments recommended";
            }
        } else { 
            if (riskTolerance.equalsIgnoreCase("Conservative")) {
                ...
                recommendation = "Portfolio does not match your risk profile";
                rebalancing = "Rebalance asset allocation accordingly";
            }
        }
